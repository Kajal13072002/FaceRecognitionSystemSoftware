...
class Face_Recognition_System:
  def __init__(self,root):
    ...
    #first image
     img=Image.open(r"college_images\d1.PNG")
     ...
     #second image 
     img1=Image.open(r"college_images\facial_recognition.PNG")
     ...
     #third image
     img2=Image.open(r"college_images\d2.JPEG")
    ...
    #backgroung image
     img3=Image.open(r"college_images\bCK.JPEG")
     ...
     #student button
     img4=Image.open(r"college_images\butt.JPEG")
     ...
     #Face Detect button
     img5=Image.open(r"college_images\bgimage.JPEG")
     ...
     #Attendance button
     img6=Image.open(r"college_images\attendance.JPEG")
